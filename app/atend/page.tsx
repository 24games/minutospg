...
// Componente do Botão WhatsApp Reutilizável com link customizado
const WhatsAppButton = ({ className = "", href }: { className?: string; href: string }) => (
  <a
    href={href}
    target="_blank"
...
export default function AtendPage() {
  ...
  // Link do botão para esta página
